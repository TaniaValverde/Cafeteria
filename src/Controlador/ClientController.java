 ...
 *
 * Manages CRUD operations for {@link Client} and persists data using {@link ClientDAO}.
 */
public class ClientController {
     ...
     */
    public ClientController(String rutaArchivo) throws IOException {
        this.clienteDAO = new ClientDAO(rutaArchivo);
     ...
     */
    public void registrar(Client cliente) throws IOException {
     ...
     * @throws IOException if persistence fails
     */
    public void modificar(String id, String nuevoNombre, String nuevoTelefono, Client.TipoCliente nuevoTipo) throws IOException {
        Client c = buscarPorId(id);
    ...
    public void ordenarPorNombre() {
        clientes.sort(Comparator.comparing(Client::getNombre, String.CASE_INSENSITIVE_ORDER));
    }
