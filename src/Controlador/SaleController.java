 ...
 *
 * Coordinates the sale workflow: order handling, persistence through {@link SaleDAO},
 * stock-related lookups through {@link ProductDAO}, and invoice text generation.
 */
public class SaleController {
     ...
     */
    public SaleController(SaleDAO ventaDAO, ProductDAO productoDAO, Clock clock) {
    ...
    public SaleController() {
        this(new SaleDAO(),
                new ProductDAO("data/productos.txt"),
    ...
    public void iniciarPedido(int codigoPedido, String tipoPedido, Integer numeroMesa) {
        pedidoActual = new Order(codigoPedido, tipoPedido, numeroMesa);
    }
     ...
     */
    public void agregarProductoAlPedido(Product producto, int cantidad) {
     ...
     */
    public Sale finalizarVenta(Client cliente, Table mesa, boolean paraLlevar) throws IOException {

        int numeroMesa = paraLlevar ? Sale.PARA_LLEVAR : mesa.getNumero();
     ...
     */
    public List<Sale> obtenerPendientes() throws IOException {
     ...
     * @throws IOException if persistence fails
     */
    public void marcarComoPagada(Sale venta, String metodoPago) throws IOException {
     ...
     */
    public void quitarProductoDelPedido(Product producto, int cantidad) {
        if (producto == null) {
     ...
     */
    public void setPedidoActual(Order pedidoActual) {
     ...
     * @return invoice text
     */
    public String generarTextoFactura(Sale venta, String metodoPagoPreview) {
        StringBuilder sb = new StringBuilder();
