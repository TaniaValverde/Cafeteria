...
/**
 * Data Access Object (DAO) for {@link Product} persistence using a local text file.
 *
...
public class ProductDAO {
     ...
     */
    public ProductDAO(String rutaArchivo) {
     ...
     */
    public List<Product> cargar() throws IOException {
        asegurarDirectorio();
        ...
        try (BufferedReader br = Files.newBufferedReader(archivo)) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                productos.add(new Product(codigo, nombre, categoria, precio, stock));
            }
        }
     ...
     * @throws IOException if a file access error occurs
     */
    public void guardar(List<Product> productos) throws IOException {
        asegurarDirectorio();
