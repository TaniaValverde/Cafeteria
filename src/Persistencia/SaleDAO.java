...
/**
 * Data Access Object (DAO) for {@link Sale} persistence using a local text file.
 *
...
public class SaleDAO {
     ...
     */
    public SaleDAO(String rutaArchivo) {
     ...
     */
    public List<Sale> cargar() throws IOException {
        asegurarDirectorio();
     ...
     * @throws IOException if a file access error occurs
     */
    public void guardar(List<Sale> ventas) throws IOException {
        asegurarDirectorio();
     ...
     */
    public void guardarVenta(Sale venta) throws IOException {
     ...
     */
    public void actualizarVenta(Sale ventaActualizada) throws IOException {
        if (ventaActualizada == null) throw new IllegalArgumentException("Venta no puede ser null.");

        List<Sale> ventas = cargar();
     ...
     * @throws IOException if a file access error occurs
     */
    public List<Sale> listarPendientes() throws IOException {
        List<Sale> ventas = cargar();
        List<Sale> pendientes = new ArrayList<>();
     ...
     */
    public void registrarVentaConStock(Sale venta, ProductDAO productoDAO) throws IOException {
        if (venta == null) throw new IllegalArgumentException("Venta no puede ser null.");
        ...
        for (Sale.LineaVenta lv : venta.getLineas()) {
            ...
            Product p = buscarProductoPorCodigo(productos, codigo);
     ...
     * @throws IOException if a file access error occurs
     */
    public ArrayList<Sale> getVentas() throws IOException {
        return new ArrayList<>(cargar());
    }

    private Product buscarProductoPorCodigo(List<Product> productos, String codigo) {
