...
public class ProductTest {
    ...
    public void constructor_yGetters_funcionan_yTrim() {
        Product p = new Product("  P001  ", "Cafe", "  Bebida  ", 1200.0, 10);
    ...
    public void setCodigo_invalido_lanza() {
        Product p = new Product("P1", "N", "C", 1.0, 1);
    ...
    public void descontarStock_casos() {
        Product p = new Product("P1", "N", "C", 1.0, 10);
    ...
    public void equals_y_hashCode_porCodigo() {
        Product a = new Product("P001", "A", "C", 1.0, 1);
        Product b = new Product("P001", "B", "D", 99.0, 999);
