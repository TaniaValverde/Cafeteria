...
public class ProductControllerTest {
    ...
    public void iniciarVacio_siArchivoNuevo() throws Exception {
        ProductController pc = new ProductController(productosPath());
    ...
    public void agregarYBuscarPorCodigo_funciona() throws Exception {
        ProductController pc = new ProductController(productosPath());
        Product p = new Product("P001", "Cafe Negro", "Bebida", 1200.0, 10);
        pc.agregar(p);

        Product encontrado = pc.buscarPorCodigo("P001");
    ...
    public void noPermiteCodigoDuplicado() throws Exception {
        ProductController pc = new ProductController(productosPath());
        pc.agregar(new Product("P001", "Cafe Negro", "Bebida", 1200.0, 10));

        try {
            pc.agregar(new Product("P001", "Sandwich", "Comida", 2000.0, 5));
    ...
    public void modificar_actualizaCampos() throws Exception {
        ...
        Product mod = pc.buscarPorCodigo("P001");
    ...
    public void eliminar_quitaProducto() throws Exception {
        ProductController pc = new ProductController(productosPath());
        pc.agregar(new Product("P001", "Cafe Negro", "Bebida", 1200.0, 10));
        pc.agregar(new Product("P002", "Sandwich", "Comida", 2000.0, 5));

        pc.eliminar("P001");

        List<Product> lista = pc.listar();
    ...
    public void ordenarPorCodigo_ordenAscendente() throws Exception {
        ProductController pc = new ProductController(productosPath());
        pc.agregar(new Product("P010", "X", "Bebida", 100, 1));
        pc.agregar(new Product("P002", "Y", "Bebida", 100, 1));
        pc.agregar(new Product("P001", "Z", "Bebida", 100, 1));
    ...
    public void ordenarPorPrecio_ordenAscendente() throws Exception {
        ProductController pc = new ProductController(productosPath());
        pc.agregar(new Product("P1", "A", "Bebida", 3000, 1));
        pc.agregar(new Product("P2", "B", "Bebida", 1000, 1));
        pc.agregar(new Product("P3", "C", "Bebida", 2000, 1));
    ...
    public void persistencia_seMantieneEntreInstancias() throws Exception {
        ...
        ProductController pc1 = new ProductController(path);
        pc1.agregar(new Product("P001", "Cafe Negro", "Bebida", 1200.0, 10));
        pc1.agregar(new Product("P002", "Sandwich", "Comida", 2000.0, 5));

        ProductController pc2 = new ProductController(path);
